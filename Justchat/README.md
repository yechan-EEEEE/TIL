...
db설계 진짜 너무 어렵다
겨우 다 했는데 맞게 된 걸까
하루종일 db만 봤는데도 이래 오래 걸리네...

# 26.03.10
ai 도대체 어떻게 시작해야 되는 거지
데이터셋 증강 전처리하고 학습 테스트 나누고
학습시킨거 테스트 해본다 요런 느낌 아닌가?
왤케 복잡하지? 뭐야? 살려줘
...
준비 시간이 너무 짧아서
발표 결과가 좀 아쉬웠다.
기술 스택 좀 더 공부하고 했어야 됐는데..
최종 발표도 공부해서 내가 해볼까?

# 26.03.18
아무리 봐도 초반에 잘못 했다
기획을 제대로 잡고 시작했으면 이렇게 안됐을텐데
내 잘못이다

# 26.03.24
오랜만에 일기 쓰기
우리 서비스 있으면 이래 안귀찮을텐데

# 26.03.25
ai 데이터 어디 하늘에서 뚝 안떨어지나
