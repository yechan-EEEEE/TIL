...
CREATE TABLE table\_name (  
    column\_name1 data\_type \[Constraints\],  
...
| **FOREIGN KEY (FK)** | 다른 테이블의 기본 키(PK)를 참조하여 테이블 간의 관계를 설정합니다. 데이터 무결성(Integrity)을 유지하는 핵심 요소입니다. | user\_id INTEGER REFERENCES users(id) |
